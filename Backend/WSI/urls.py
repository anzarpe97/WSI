...
urlpatterns = [
    ...
    path('api/vehiculos/registrar/', VehiculoCreateView.as_view(), name='registrar-vehiculo'),
    path('api/documentos-vehiculos-verificar/', DocumentosVehiculoListAPIView.as_view(), name='documentos-vehiculos-list'),
